package com.nbank.credit.spark
...
class SparkContextFactory {
  ...
  def setProperties(sparkSession: SparkSession) = {
    ...
    sparkSession.conf.set("spark.app.name", "Credit Card Analytics")
    ...
    sparkSession.conf.set("spark.extraListeners", "com.nbank.credit.spark.MySparkListener")
...
/* Companion object */
object SparkContextFactory extends com.nbank.credit.config.ProjectConfig {
